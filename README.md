...
fine news --provider xueqiu --symbols sh600519

# 获取第一财经新闻（需要 Playwright）
fine news --provider yicai --symbols sh600519
...
# 输出到指定目录
fine news --provider akshare --symbols sh600519 --result /tmp
```
