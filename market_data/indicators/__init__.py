...
from .oscillator import WR, CCI, BIAS, CR, ARBR, PSY, DMI, UltimateOscillator, DMA, TRIX
import numpy as np
...
IndicatorRegistry.register(BIAS)
IndicatorRegistry.register(CR)
IndicatorRegistry.register(ARBR)
IndicatorRegistry.register(PSY)
IndicatorRegistry.register(DMI)
IndicatorRegistry.register(UltimateOscillator)
IndicatorRegistry.register(DMA)
